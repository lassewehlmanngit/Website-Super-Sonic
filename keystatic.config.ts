...
const storage =
  import.meta.env.VITE_KEYSTATIC_GITHUB_REPO_OWNER &&
  import.meta.env.VITE_KEYSTATIC_GITHUB_REPO_NAME
    ? {
        kind: 'github' as const,
        repo: {
          owner: import.meta.env.VITE_KEYSTATIC_GITHUB_REPO_OWNER,
          name: import.meta.env.VITE_KEYSTATIC_GITHUB_REPO_NAME,
        },
      }
    : {
        kind: 'local' as const,
